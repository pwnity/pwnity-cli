...
class ParserFactory:
    ...
    def _populate_logbook_parser(self, parser, logbook_completer=None):
        ...
        list_parser = subparsers.add_parser("list",
                                            ...
                                            formatter_class=self.formatter, add_help=False)
        self._add_custom_help(list_parser, "list")
        list_parser.add_argument("-n", "--limit", type=int, default=0, help="Number of entries to show (0 for all, default: 0).")
        ...
        filter_parser.add_argument("-n", "--limit", type=int, default=0, help="Number of entries to show (0 for all, default: 0).")
